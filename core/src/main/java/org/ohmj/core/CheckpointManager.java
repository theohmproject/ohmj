 ...
 * {@link org.ohmj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with ohmj */
    ...
    /** Returns a checkpoints stream pointing to inside the ohmj JAR */
