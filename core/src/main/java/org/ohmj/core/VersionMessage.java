...
public class VersionMessage extends Message {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for ohmj
     * users might look like "/ohmj:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/ohmj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
