...
import org.ohmj.crypto.MnemonicCode;
import org.ohmj.crypto.MnemonicException;
import org.ohmj.net.discovery.PeerDiscovery;
import org.ohmj.net.discovery.PeerDiscoveryException;
...
public class MatiTest {
    ...
    public void accountDetailsTest(){
        ...
        Wallet wallet = Wallet.fromSeed(
                networkParameters,
                seed,
                DeterministicKeyChain.KeyChainType.BIP44_OHM_ONLY
        );
    ...
    public Wallet restore(NetworkParameters networkParameters) throws IOException {
        String filename = "2.0.32_pivx-wallet-backup_org.concierge.production-2017-11-20";
        //"1.01_pivx-wallet-backup_org.concierge.production-2017-07-26 (2)";
    ...
    public void watchOnlyTest(){
        ...
        Wallet watchingWallet = Wallet.fromWatchingKeyB58(networkParameters,xpub,0, DeterministicKeyChain.KeyChainType.BIP44_OHM_ONLY);
