...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.ohmj.store.SPVBlockStore} or you could also try a
     * {@link org.ohmj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
