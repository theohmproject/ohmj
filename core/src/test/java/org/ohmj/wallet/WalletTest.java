...
import org.ohmj.core.AbstractBlockChain;
import org.ohmj.core.Address;
import org.ohmj.core.Block;
import org.ohmj.core.BlockChain;
import org.ohmj.core.Coin;
import org.ohmj.core.ECKey;
import org.ohmj.core.InsufficientMoneyException;
import org.ohmj.core.PeerAddress;
import org.ohmj.core.Sha256Hash;
import org.ohmj.core.StoredBlock;
import org.ohmj.core.Transaction;
import org.ohmj.core.TransactionConfidence;
import org.ohmj.core.TransactionInput;
import org.ohmj.core.TransactionOutPoint;
import org.ohmj.core.TransactionOutput;
import org.ohmj.core.Utils;
import org.ohmj.core.VerificationException;
import org.ohmj.core.TransactionConfidence.ConfidenceType;
import org.ohmj.crypto.*;
import org.ohmj.script.Script;
import org.ohmj.script.ScriptBuilder;
import org.ohmj.signers.StatelessTransactionSigner;
import org.ohmj.signers.TransactionSigner;
import org.ohmj.store.BlockStoreException;
import org.ohmj.store.MemoryBlockStore;
import org.ohmj.testing.*;
import org.ohmj.utils.ExchangeRate;
import org.ohmj.utils.Fiat;
import org.ohmj.utils.Threading;
import org.ohmj.wallet.Wallet.BalanceType;
import org.ohmj.wallet.WalletTransaction.Pool;
...
import org.ohmj.wallet.Protos.Wallet.EncryptionType;
...
import static org.ohmj.core.Coin.*;
import static org.ohmj.core.Utils.HEX;
import static org.ohmj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: ohmj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("ohmj-unit-test", null);
