...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link org.ohmj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
    ...
    public static DeterministicKey deserialize(NetworkParameters params, byte[] serializedKey, @Nullable DeterministicKey parent, DeterministicKeyChain.KeyChainType keyChainType) {
        ...
        if (parent != null) {
            ...
            if (depth >= 1)
                ...
                // parent's node.
                if (keyChainType == DeterministicKeyChain.KeyChainType.BIP44_OHM_ONLY){
     ...
     * in which case the time is stored alongside the key as per normal, see {@link org.ohmj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
