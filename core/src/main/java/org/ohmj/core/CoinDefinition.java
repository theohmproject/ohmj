...
public class CoinDefinition {
    ...
    public static final String coinName = "OHM";
    public static final String coinTicker = "OHM";
    public static final String coinURIScheme = "OHM";
    public static final String cryptsyMarketId = "155";
    public static final String cryptsyMarketCurrency = "OHM";
    ...
    public static final int Port    = 52020;       //protocol.h GetDefaultPort(testnet=false)
    public static final int TestPort = 52024;     //protocol.h GetDefaultPort(testnet=true)
    ...
    //
    public static final int AddressHeader = 80;             //base58.h CBitcoinAddress::PUBKEY_ADDRESS
    public static final int p2shHeader = 13;             //base58.h CBitcoinAddress::SCRIPT_ADDRESS
    public static final int dumpedPrivateKeyHeader = 128;   //common to all coins
    public static final long oldPacketMagic = 0x457665ba;      // 0x45, 0x76, 0x65, 0xba

    public static final long PacketMagic = 0x81b4eda9;


    //Genesis Block Information from main.cpp: LoadBlockIndex
    static public long genesisBlockDifficultyTarget = 0x1e0ffff0;         //main.cpp: LoadBlockIndex
    static public long genesisBlockTime = 1513867516;                       //main.cpp: LoadBlockIndex
    static public long genesisBlockNonce = 2266164;                         //main.cpp: LoadBlockIndex
    static public String genesisHash = "bf7fdb166c58ef349097c3964b433a9821983483307cf5fc71335fd7b380fe36";  //main.cpp: hashGenesisBlock
    static public String genesisMerkleRoot = "48f5858d0f091dec3f5278144cdcca7c8926b091d5af5ea711539f29f1acaf8";
    ...
    public static final String genesisTxPubKey = "04d10e83b2703ccf322f7dbd62dd5435ac7c10bd055814ce121ba32607d573b8810c02c0582aed05b4deb9c4b77b26d92428c61256cd42774babea0a073b2ed0c9";

    //net.cpp strDNSSeed
    static public String[] dnsSeeds = new String[] {
            "209.250.241.176","209.250.241.176","209.250.243.131","209.250.243.131","45.77.239.108","45.77.239.108","107.191.44.102"
    };
    ...
    static public String[] testnetDnsSeeds = new String[] {
            "concierge-testnet.seed.fuzzbawls.pw",
            "concierge-testnet.seed2.fuzzbawls.pw",
            "s3v3nh4cks.ddns.net"
    };
    //from main.h: CAlert::CheckSignature
    public static final String SATOSHI_KEY = "0000076d3ba6ba6e7423fa5cbd6a89e0a9a5348f88d332b44a5cb1a8b7ed2c1eaa335fc8dc4f012cb8241cc0bdafd6ca70c5f5448916e4e6f511bcd746ed57dc50";
    ...
    public static final String ID_MAINNET = "org.ohm.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.ohm.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.ohm.unittest";
