...
import org.ohmj.net.discovery.HttpDiscovery;
import org.ohmj.params.*;
import org.ohmj.script.Script;
import org.ohmj.script.ScriptBuilder;
import org.ohmj.script.ScriptChunk;
import org.ohmj.script.ScriptOpCodes;
...
import org.ohmj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.concierge.regtest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.ohmj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.ohmj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.ohmj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.ohmj.core.AlertMessage}s. You can use {@link org.ohmj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
