...
import org.ohmj.protocols.channels.*;
import org.ohmj.store.*;
import org.ohmj.wallet.*;
import org.slf4j.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV ohmj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit ohmj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing ohmj
...
public class WalletAppKit extends AbstractIdleService {
    ...
    public WalletAppKit(Context context, File directory, String filePrefix) {
        ...
        context.initConcierge(false, true);
     ...
     * {@link org.ohmj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the ohmj website for further details.
     */
