...
package org.ohmj.examples;

import org.ohmj.core.*;
import org.ohmj.kits.WalletAppKit;
...
/**
 * The following example shows how to use the by ohmj provided WalletAppKit.
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV ohmj app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // ohmj is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://github.com/google/guava/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();
