...
/**
 * <p>A KeyChainGroup is used by the {@link org.ohmj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.ohmj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.ohmj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.ohmj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
