...
import org.ohmj.wallet.KeyChain.KeyPurpose;
import org.ohmj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.ohmj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.ohmj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
