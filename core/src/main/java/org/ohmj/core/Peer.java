...
import org.ohmj.net.StreamConnection;
import org.ohmj.store.BlockStore;
import org.ohmj.store.BlockStoreException;
import org.ohmj.utils.ListenerRegistration;
 ...
 * {@link org.ohmj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.ohmj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.ohmj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.ohmj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.ohmj.core.TxConfidenceTable}
    ...
    protected void processMessage(Message m) throws Exception {
        ...
        else if(m instanceof SporkMessage)
        {
            ...
            // todo furszy: check concierge masternodes
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // ohmj is a client mode implementation. That means there's not much point in us talking to other client
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.ohmj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.ohmj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.ohmj.core.Peer#ping()} has never
