...
This will download the block chain and eventually print a OHM address that it has generated.

If you send coins to that address, it will forward them on to the address you specified.

```
  cd examples
  mvn exec:java -Dexec.mainClass=org.ohmj.examples.ForwardingService -Dexec.args="<insert a ohm address here>"
