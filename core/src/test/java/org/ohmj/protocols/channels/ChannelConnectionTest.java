...
import static org.ohmj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.ohmj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.ohmj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
