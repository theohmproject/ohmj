...
package org.ohmj.utils;

import org.ohmj.core.CoinDefinition;
 ...
 * ohmj performs cycle detection or not. Cycle detection is useful to detect bugs but comes with a small cost.
...
public class Threading {
     ...
     * ohmj internally shouldn't normally run here, although currently there are a few exceptions.
     */
     ...
     * ohmj library code is run, setting it after you started network traffic and other forms of processing
    ...
    static {
        ...
        // instantiating any ohmj objects. The policy change will take effect only on new objects
