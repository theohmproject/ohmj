...
public final class MonetaryFormat {
    ...
    public static final String CODE_BTC = "CCC";
    ...
    /**
     * Parse a human readable coin value to a {@link org.ohmj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.ohmj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
