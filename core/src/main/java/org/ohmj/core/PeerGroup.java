...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of ohmj fixes the known
     ...
     * {@link org.ohmj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.ohmj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.ohmj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.ohmj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.ohmj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.ohmj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.ohmj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.ohmj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.ohmj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a ohmj based app running in SPV mode to fully validating security.
     */
