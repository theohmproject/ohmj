...
import org.ohmj.core.*;
import org.ohmj.core.Message;
import org.ohmj.core.listeners.*;
import org.ohmj.core.TransactionConfidence.*;
import org.ohmj.crypto.*;
import org.ohmj.script.*;
import org.ohmj.signers.*;
import org.ohmj.utils.*;
import org.ohmj.wallet.Protos.Wallet.*;
import org.ohmj.wallet.WalletTransaction.*;
import org.ohmj.wallet.listeners.KeyChainEventListener;
import org.ohmj.wallet.listeners.ScriptsChangeEventListener;
import org.ohmj.wallet.listeners.WalletChangeEventListener;
import org.ohmj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.ohmj.wallet.listeners.WalletCoinsSentEventListener;
import org.ohmj.wallet.listeners.WalletEventListener;
import org.ohmj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.ohmj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_OHM_ONLY? 1 : 0;
     ...
     * {@link org.ohmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.ohmj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ohmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.ohmj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.ohmj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ohmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.ohmj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.ohmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.ohmj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ohmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.ohmj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.ohmj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ohmj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of ohmj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.ohmj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.ohmj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.ohmj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.ohmj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.ohmj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.ohmj.crypto.KeyCrypter,
     ...
     * {@link org.ohmj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.ohmj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.ohmj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.ohmj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.ohmj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.ohmj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
