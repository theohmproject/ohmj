 ...
 *
 * <p>TransactionConfidence is updated via the {@link org.ohmj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link org.ohmj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link org.ohmj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link org.ohmj.core.TransactionConfidence#getConfidenceType()}
            ...
            SEEN_PEERS,
            /**
             * Occurs when the type returned by {@link org.ohmj.core.TransactionConfidence#getIXType()}
     ...
     * and so on. This information is useful for {@link org.ohmj.wallet.CoinSelector} implementations to risk analyze
